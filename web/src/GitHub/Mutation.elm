...
-}
deleteDeployment : DeleteDeploymentRequiredArguments -> SelectionSet decodesTo GitHub.Object.DeleteDeploymentPayload -> SelectionSet (Maybe decodesTo) RootMutation
